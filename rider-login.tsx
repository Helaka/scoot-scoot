...
export default function RiderLogin() {
  ...
  const handleDemoLogin = () => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      router.push("/rider-dashboard?demo=true")
    }, 1500)
  }
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-white/90 backdrop-blur-sm dark:bg-gray-800/90">
          <CardHeader className="space-y-1 flex flex-col items-center">
            ...
            <CardTitle className="text-2xl">Rider Access</CardTitle>
            <CardDescription>Login to your rider account or try our demo</CardDescription>
          </CardHeader>
